    ...
    <Sidebar>
      <SidebarHeader className="border-b border-sidebar-border px-4 py-3.5">
        ...
        >
          ...
          <span>Lance Multimodal Search</span>
        </Link>
      </SidebarHeader>
      ...
      <SidebarFooter className="border-t border-sidebar-border px-4 py-3">
        <a
          href="https://www.backblaze.com/cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=b2ai-lance-multimodal-search"
          target="_blank"
